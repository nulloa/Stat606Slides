...
\medskip
\textit{nulloa1@iastate.edu} % Your email address
}
...
%------------------------------------------------
\section{GPU} % Sections can be created in order to organize your presentation into discrete blocks, all sections and subsections are automatically printed in the table of contents as an overview of the talk
%------------------------------------------------

\subsection{What is a GPU?} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
...
\item Motivation is still the same
\end{itemize}
\end{frame}
...
\end{itemize}
\begin{center}
\includegraphics[height=0.4\textheight]{cpu-and-gpu.jpg}
\end{center}
\end{frame}
